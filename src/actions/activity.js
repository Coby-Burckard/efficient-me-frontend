import { fetchAddActivity, fetchEditActivity, fetchDeleteActivity } from '../ajaxOrLocal/activity'
...
const startDeleteActivity = (token, activityID) => {
  return dispatch => {
    fetchDeleteActivity(token, activityID)
      .then(response => {
...
export { startAddActivity, startEditActivity, startDeleteActivity };